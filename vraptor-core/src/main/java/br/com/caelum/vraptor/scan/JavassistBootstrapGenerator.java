...
public class JavassistBootstrapGenerator implements BootstrapGenerator {
    ...
    private static String createMethodDef(Collection<String> components) {
        StringBuilder methodDef = new StringBuilder().append("public void configure (br.com.caelum.vraptor.ComponentRegistry registry){");
        for (String componentName : components) {
            methodDef.append("registry.deepRegister(").append(componentName).append(".class);");
        }
        methodDef.append('}');
